...
export const DUMMY_MEAL_PLANS: MealPlan[] = [
  {
    ...
    isActive: true,
    dishes: [
      { id: 'mpd1', dishId: 'd1', name: DUMMY_DISHES[0].name, description: DUMMY_DISHES[0].description, price: DUMMY_DISHES[0].price, imageUrl: DUMMY_DISHES[0].imageUrl, isActive: true },
      { id: 'mpd2', dishId: 'd6', name: DUMMY_DISHES[5].name, description: DUMMY_DISHES[5].description, price: DUMMY_DISHES[5].price, imageUrl: DUMMY_DISHES[5].imageUrl, isActive: true },
    ],
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    ...
    isActive: true,
    dishes: [
      { id: 'mpd3', dishId: 'd2', name: DUMMY_DISHES[1].name, description: DUMMY_DISHES[1].description, price: DUMMY_DISHES[1].price, imageUrl: DUMMY_DISHES[1].imageUrl, isActive: true },
      { id: 'mpd4', dishId: 'd4', name: DUMMY_DISHES[3].name, description: DUMMY_DISHES[3].description, price: DUMMY_DISHES[3].price, imageUrl: DUMMY_DISHES[3].imageUrl, isActive: true },
      { id: 'mpd5', dishId: 'd5', name: DUMMY_DISHES[4].name, description: DUMMY_DISHES[4].description, price: DUMMY_DISHES[4].price, imageUrl: DUMMY_DISHES[4].imageUrl, isActive: true },
    ],
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    ...
    isActive: true,
    dishes: [
      { id: 'mpd6', dishId: 'd3', name: DUMMY_DISHES[2].name, description: DUMMY_DISHES[2].description, price: DUMMY_DISHES[2].price, imageUrl: DUMMY_DISHES[2].imageUrl, isActive: true },
      { id: 'mpd7', dishId: 'd1', name: DUMMY_DISHES[0].name, description: DUMMY_DISHES[0].description, price: DUMMY_DISHES[0].price, imageUrl: DUMMY_DISHES[0].imageUrl, isActive: true },
    ],
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
