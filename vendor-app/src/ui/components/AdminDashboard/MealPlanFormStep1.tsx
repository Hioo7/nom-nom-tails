...
interface MealPlanFormStep1Props {
  name: string;
...
export default function MealPlanFormStep1({
  name,
  onNameChange,
  description,
  onDescriptionChange,
    ...
    <>
      ...
      <fieldset className="fieldset py-1">
        ...
        <input
          ...
          placeholder="e.g. Weekly Veg Thali"
          value={name}
      ...
      <fieldset className="fieldset py-1">
        ...
        <textarea
          ...
          placeholder="Optional — a short description of this meal plan"
          rows={2}
          value={description}
      ...
      <div className="flex items-center justify-between py-2">
        <span className="text-sm font-medium text-base-content">Active in Storefront</span>
        <input
          type="checkbox"
